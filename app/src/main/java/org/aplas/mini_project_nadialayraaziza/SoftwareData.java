...
public class SoftwareData {
    ...
    private static String [] link = {
            ...
            "https://www.3ds.com/",
            "https://www.navercorp.com/en/naver/company",
    ...
    private static String [] deskripsi = {
            ...
            "Match Group, Inc. is an American internet and technology company headquartered in Dallas, Texas. It owns and operates the largest global portfolio of popular online dating services including Tinder, Match.com, Meetic, OkCupid, Hinge, PlentyOfFish, Ship, and OurTime totalling over 45 global dating companies. The company was owned by parent company IAC and in 2019, the company had 9.283 million subscribers, of which 4.554 million were in North America.[1] Japan is the company's second largest market. In July 2020, Match Group became a separate, public company.",
            "Tech Mahindra adalah perusahaan multinasional India yang menyediakan layanan teknologi informasi (TI) dan outsourcing proses bisnis (BPO). Sebuah anak perusahaan dari Mahindra Group , perusahaan ini berkantor pusat di Pune dan memiliki kantor terdaftar di Mumbai. Per April 2020, Tech Mahindra adalah perusahaan senilai US$ 5,2 miliar dengan 125.236 karyawan di 90 negara. Perusahaan ini menduduki peringkat #5 di perusahaan TI India dan keseluruhan #47 dalam daftar Fortune India 500 untuk 2019. Pada 25 Juni 2013, Tech Mahindra mengumumkan penyelesaian merger dengan Mahindra Satyam. Tech Mahindra memiliki 973 klien aktif per April 2020.",
            "Tencent Holdings adalah perusahaan induk konglomerat teknologi multinasional China. Didirikan pada tahun 1998, anak perusahaannya secara global memasarkan berbagai layanan dan produk yang berhubungan dengan Internet, termasuk dalam hiburan, kecerdasan buatan, dan teknologi lainnya. Kantor pusatnya, gedung pencakar langit Tencent Seafront Towers (juga dikenal sebagai Tencent Binhai Mansion) berbasis di Distrik Nanshan, Shenzhen. Tencent adalah vendor permainan video terbesar di dunia, sekaligus salah satu perusahaan yang paling bernilai secara finansial. Tencent merupakan salah satu perusahaan media sosial terbesar, perusahaan modal ventura, dan perusahaan investasi. Layanannya meliputi jaringan sosial, musik, portal web, perdagangan elektronik, permainan piranti bergerak, layanan internet, sistem pembayaran, ponsel cerdas, dan permainan online multipemain.",
            "Constellation Software adalah perusahaan perangkat lunak terdiversifikasi Kanada. Ini berbasis di Toronto , Kanada, terdaftar di Bursa Efek Toronto , dan merupakan konstituen dari S&P/TSX 60. Perusahaan ini didirikan oleh Mark Leonard, mantan pemodal ventura, pada tahun 1996. Perusahaan ini go public pada tahun 2006, dan sekarang memiliki 13.000 karyawan tersebar di 6 segmen operasi. Strategi bisnis perusahaan adalah mengakuisisi perusahaan perangkat lunak, dan kemudian menahannya untuk jangka panjang. Ini telah mengakuisisi lebih dari 500 bisnis sejak didirikan. Ini berfokus pada perusahaan perangkat lunak pasar vertikal (yaitu mereka yang membuat perangkat lunak untuk industri atau pasar tertentu, sebagai lawan dari membuat perangkat lunak yang dapat digunakan untuk berbagai pasar).",
            "Dassault Systèmes adalah penerbit perangkat lunak yang berspesialisasi dalam desain 3D, mock-up digital 3D, dan solusi untuk manajemen siklus hidup produk (PLM). Dibuat pada tahun 1981 untuk mengkomputerisasi desain pesawat terbang, Dassault Systèmes, berdasarkan gagasan \"virtualisasi dunia\", telah memperluas aktivitasnya dalam pengembangan dan pemasaran perangkat lunak profesional untuk semua bidang, baik industri (aeronautika dan pertahanan, teknik dan konstruksi, energi, consumer goods, dll.) yang antara lain menyangkut arsitektur atau ilmu hayati. Pada tahun 2015, Dassault Systèmes adalah penerbit perangkat lunak Prancis terkemuka dalam hal omset dan yang kedua di Eropa setelah SAP Jerman. Perusahaan ini berkantor pusat di Vélizy-Villacoublay, di bagian utara pusat teknologi Paris-Saclay.",
            "Naver Corporation adalah sebuah perusahaan pengembang Korea Selatan yang berkantor pusat di Seongnam, Korea Selatan yang mengoperasikan mesin pencari Naver. Naver memantapkan dirinya sebagai pelopor awal dalam penggunaan konten buatan pengguna melalui pembuatan platform Tanya Jawab online, Knowledge iN. Naver juga mengelola layanan seluler global seperti LINE messenger seluler, messenger video Snow, dan layanan komunikasi grup BAND. Pada tanggal 1 Agustus 2013, Naver memutuskan untuk berpisah dengan Hangame, sebuah perusahaan yang telah tumbuh bersama sebagai Perusahaan NHN selama 13 tahun. Pada tanggal 1 Oktober 2013, perusahaan mengadopsi nama saat ini Naver Corporation untuk mencerminkan perubahan tersebut, memulihkan nama sebelum penggabungan. Hangame sekarang diawasi oleh NHN Entertainment. Afiliasi Naver saat ini termasuk Line Corporation, Snow, Naver Labs, Naver Webtoon, Naver Business Platform, dan Works Mobile. Perusahaan saat ini bekerja sama dengan startup IT untuk berkembang menjadi platform berbasis teknologi.",
            ...
            "Intuit Inc. adalah sebuah perusahaan perangkat lunak yang mengembangkan perangkat lunak keuangan dan persiapan pajak dan jasa terkait untuk bisnis kecil, akuntan, dan individu. Perusahaan ini didirikan di Delaware dan berkantor pusat di Mountain View, California. Perusahaan ini didirikan tahun 1983 oleh Scott Cook dan Tom Proulx di Mountain View, California. Intuit membuat program keuangan pribadi bernama Quicken dan TurboTax (dan versi Kanadanya, QuickTax), serta program akuntansi untuk bisnis kecil bernama QuickBooks. Selain itu, mereka menciptakan solusi QuickBooks Point of Sale untuk pengecer kecil, solusi pajak profesional ProSeries dan Lacerte, dan solusi produktivitas kelompok kerja perusahaan berbasis web bernama QuickBase. Perusahaan ini memiliki beberapa kantor pemasaran di luar negeri. Aktivitas R&D-nya dilaksanakan di Intuit Canada yang berkantor pusat di Mississauga, Ontario dan Intuit India yang berkantor pusat di Bangalore, India. Produk internasionalnya diproduksi oleh produsen lokal pihak ketiga.",
            ...
            "Verisign Inc adalah perusahaan Amerika yang berbasis di Reston, Virginia , Amerika Serikat yang beroperasi beragam infrastruktur jaringan, termasuk dua dari Internet 's tiga belas root nameserver , registri otoritatif untuk .com , .net , dan .name generik domain tingkat atas dan domain tingkat atas kode negara .cc dan .tv , serta sistem back-end untuk domain tingkat atas .jobs , .gov , dan .edu . Verisign juga menawarkan berbagai layanan keamanan, termasuk dikelola DNS , mitigasi serangan penolakan layanan (DDoS) terdistribusi dan pelaporan ancaman dunia maya. Verisign didirikan pada tahun 1995 sebagai spin-off dari bisnis layanan sertifikasi Keamanan RSA . Perusahaan baru menerima lisensi untuk paten kriptografi kunci yang dipegang oleh RSA (akan berakhir pada tahun 2000) dan perjanjian non-persaingan terbatas waktu. Perusahaan baru ini berfungsi sebagai otoritas sertifikat (CA) dan misi awalnya adalah \"memberikan kepercayaan untuk Internet dan Perdagangan Elektronik melalui layanan dan produk Otentikasi Digital kami\". Sebelum menjual bisnis sertifikatnya ke Symantec pada 2010, Verisign memiliki lebih dari 3 juta sertifikat yang beroperasi untuk segala hal mulai dari militer hingga layanan keuangan dan aplikasi ritel, menjadikannya CA terbesar di dunia.",
