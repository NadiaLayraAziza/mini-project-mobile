...
public class SoftwareData {
    ...
    private static String [] pendidikan = {
            "Marshall Business School, USC", //Software
            "Saint Ignatius High School",
            "The Lawrevce School, Harvard University",
            "Shenzhen University",
            "Esiee Paris, Lycee Condorcet",
            "KAIST 한국과학기술원 대덕캠퍼스, Seoul National University",
